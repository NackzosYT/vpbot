...
client.on('ready', () => {
    ...
    console.log('')
    console.log('╚[════════════════════════════════════]╝')
          client.user.setActivity("!help | ViperBot",{type: 'STREAMING'});      
});
...
client.on('guildCreate', guild => {
  ...
  client.channels.get("539196775483965451")
const embed = new Discord.RichEmbed()
...
Servers Counter : __${client.guilds.size}__**`)
         .setColor("#f3ae10")
         .addField("New Server!")
         .setFooter('Viper Bot' , client.user.avatarURL)
           client.channels.get("539196775483965451").send({embed}); //Sup
}
...
Servers Counter : __${client.guilds.size}__**`)
         ...
         .setFooter('Heem Bot' , client.user.avatarURL)
           client.channels.get("539196775483965451").send({embed});
}
...
client.on('message', async message => {
  if(message.content.startsWith("!bcall")) {
    ...
    if(message.author.id !== '538100620238782464') return message.channel.send('❎ » هذا الأمر مخصص لصاحب البوت فقط');
...
Bot Developer | <@538100620238782464>
...
if (message.content === '!support') {
     message.author.send(' | https://discord.gg/TsRXyxR | For any Problem').catch(e => console.log(e.stack));
...
if (message.content === '!inv') {
     message.author.send(' Bot Link |  https://discordapp.com/api/oauth2/authorize?client_id=539194846435344405&permissions=8&scope=bot ').catch(e => console.log(e.stack));
...
👑!mcstats 『Give an informations for Minecraft Server』
